# https://github.com/ZacGeurts
# Makefile for building linesplus and songgen
# We do not install so we do not need a password.
# If you break a file you can redownload for free.
# Use AI to be your programmer.
# do not feed the AI .song files.
# other than song1.song and at your own risk, do not modify .song files.
# my error handling may not account for YOUR mistakes.
# Do not edit this file. Check out instruments folder and .h and .cpp can be modified.
# src include instruments folders contain your editable files.
#
# HOW TO USE:
# - Run 'make' to build linesplus and songgen (easiest way).
# - Run 'make -j$(nproc)' to build faster using all your computer's power. (sudo apt install nproc)
# - Run 'make clean' if you changed any code. Run this before running make again.
...
SRC_DIR = src
INCLUDE_DIR = include instruments
OBJ_DIR = obj
...
# If you have time then work on the better stuff and not songview
